  ...
  <q-layout view="lHh Lpr lFf">
    <q-header class="bg-white text-blue-grey-14">
      <q-toolbar>
        ...
        <q-btn flat round>
          <q-avatar>
            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ6FwZmHcWU4zq1mDuwoRQ-qPvbKJBJ-gvjSA&usqp=CAUs">
          </q-avatar>
          <q-menu>
      ...
      <q-scroll-area class="fit">
        <q-list>
          <q-item class="justify-center text-center q-mt-md">
            <div>
              <q-avatar size="120px">
                <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ6FwZmHcWU4zq1mDuwoRQ-qPvbKJBJ-gvjSA&usqp=CAU">
              </q-avatar>
              <div class="text-weight-bold q-mt-md">{{ $q.localStorage.getItem('dataUser') .namaLengkap }}</div>
              <div>Aplikasi Pendaftaran Mapala</div>
            </div>
          </q-item>
          ...
          <q-item clickable active-class="active" v-ripple exact :to="{ name: 'dataMapala' }">
            <q-item-section avatar>
              <q-icon name="dashboard"/>
            </q-item-section>
            <q-item-section>
              <q-item-label>Data Mapala</q-item-label>
            </q-item-section>
          </q-item>
          <q-item clickable active-class="active" :to="{ name: 'inputBarang' }" v-ripple exact>
            ...
            <q-item-section>
              <q-item-label>Input Mapala</q-item-label>
            </q-item-section>
          </q-item>
