...
const routes = [
  {
    ...
    children: [
      ...
      { path: 'datamapala', name: 'dataMapala', component: () => import('src/pages/admin/DataMapala.vue') },
      { path: 'editmapala/:id', name: 'editMapala', component: () => import('pages/admin/FormEdit.vue') }
    ]
  },
  {
    path: '/user',
